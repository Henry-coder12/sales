...
?>
        <div class='tabla'>
            ...
            foreach ($ventas_pasajes as $value) {
                ...
                if ($value->cancel_sale=='1') {
                    echo "<div class='fila'>";
                        ...
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>".number_format($Total,2).'</div>';
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>ANULADO</div>";
                    echo '</div>';
                    ...
                    echo "<div class='fila'>";
                        ...
                        echo "<div class='col' style='height: 11px;width: 70px;text-align: left;'>".$value->serie.'-'.$value->number.'</div>';
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>".number_format($Total,2).'</div>';
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>F.LIBRE</div>";
                    echo '</div>';
                    ...
                    echo "<div class='fila'>";
                        ...
                        echo "<div class='col' style='height: 11px;width: 70px;text-align: left;'>".$value->serie.'-'.$value->number.'</div>';
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>".number_format($Total,2).'</div>';
                        echo "<div class='col' style='height: 11px;width: 60px;text-align: right;'>POSTERG</div>";
                    echo '</div>';
                    $total_pasajes=$total_pasajes+$Total;
                }else{
                    echo "<div class='fila'>";
            ...
            <div class='fila' style='height: 16px;' >
                <div class='col' style='width: 100px;font-size: 13px;'><b>TOTAL PASAJ.</b></div>
                <div class='col' style='width: 60px;font-size: 13px;text-align: right;'><b><?php echo number_format($total_pasajes,2); ?></b></div>
            </div>           
