												...
												<div class="widget-main padding-24">
																		...
																		<form class="form-horizontal" role="form">
								                                          ...
								                                          <div class="form-group" style="margin-bottom: 5px;">
								                                          	<div class="col-sm-9">
									                                            ...
									                                            <div class="col-md-4">
									                                              <input type="password" maxlength="4" class="form-control input-sm nopalote" id="clave" placeholder="1234" style="text-transform:uppercase;" title='Clave' onkeypress="if (event.keyCode==13) { getElementById('clave_re').focus(); }">
									                                            </div>
									                                            <div class="col-md-4">
									                                              <input type="password" maxlength="4" class="form-control input-sm nopalote" id="clave_re" placeholder="1234" style="text-transform:uppercase;" title='Clave' onkeypress="if (event.keyCode==13) { getElementById('printer').focus(); }">
									                                            </div>
								                                            </div>
								                                            <div class="col-sm-3" id='divcreditclient' style="display:none;">
									                                          	<input type="checkbox" id="creditClient"  name="creditClient"> Credito
								                                            </div>
								                                          </div>
																...
																<ul class="list-unstyled  spaced">
																	<li>
																		...
																		<form class="form-horizontal" role="form">
								                                          ...
								                                          <div class="form-group" style="margin-bottom: 5px;">
								                                            <div class="col-sm-11">
								                                              <input type="text" class="form-control input-sm" id="receptdireccion" placeholder="Direccion"  style="text-transform:uppercase;"  title='Ingrese direccion del consignatario' onkeypress="if (event.keyCode==13) { getElementById('numphone').focus(); }">
								                                            </div>
								                                          </div>
								                                          <div class="form-group" style="margin-bottom: 5px;">
								                                          	<div class="col-sm-12">
									                                            ...
									                                            <div class="col-sm-7">
									                                              <input type="text" class="form-control input-sm nopalote" id="numphone" placeholder="99999999"  title='Clave' onkeypress="if (event.keyCode==13) { getElementById('DestineId').focus(); }">
									                                            </div>
								                                            </div>
								                                          </div>
													...
													<div class="alert alert-block alert-info fade in">
														<div class="form-group" style="margin-bottom: 5px;">
				                                            ...
				                                            <div class="col-sm-3" id="divpagodestino">
													...
													<div class="row-fluid">
														...
														<div class="span9 pull-left">
															<table>
																<tr>
																	<td>
																	<?php echo $this->Form->create(null, array('url' => array('controller' => 'sales', 'action' => 'commends_print'),'target'=>'hidden_iframe','id'=>'form_commends')); ?>
																	...
																	//credit client 
																	echo $this->Form->hidden('Remit.credit',['id'=>'RemitCredit']);
																	...
																	echo $this->Form->hidden('Commends.clave',['id'=>'CommendClave']);
																	echo $this->Form->hidden('Consig1.num_phone',['id'=>'Consig1NumPhone']);
...
$("#printer").click(function (){
	...
	*/
	...
	$('#CommendClave').val($('#clave').val());
	$('#Consig1NumPhone').val($('#numphone').val());
	...
	if($('#SerieDocument').val()=='03' && $("#doclient").val().length<8){
        ...
        location.reload();
        return false;
	}else if($("#numphone").val() == ''){
        alert('Ingrese el Numero de CELULAR para el RECOJO DE LA ENCOMIENDA');
		$('#numphone').focus();		 
    	return false;
	}else if($("#clave").val() != $("#clave_re").val()){
