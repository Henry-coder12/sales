...
<?php if($autori==true){ ?>
        ...
        <div class='tabla'>
            <div class='fila'>
                <div class='col' style='width: 230px;text-align:center;font-size: 15px;font-weight: bold;'>
                    <?php echo $this->Html->image('jatsa.png', ['width' => '170px;']);?>                    
                </div>
            </div>
            <div class='fila'>
            ...
            <div class='fila'>
                <div class='col' style='width: 250px;font-size: 11px;text-align:center;font-weight: bold;'>GUIA DE ENCOMIENDA </div>
            </div>
            <div class="fila">
            ...
            <div class='fila'>
                <div class='col' style='width: 250px;'><b>REMITENTE : </b><?php if ($datos['doc']=='01') { echo 'RUC : '.substr(strtoupper($datos['client']['ruc']), 0, 50); }else{ echo 'DNI : '.substr(strtoupper($datos['client']['document']), 0, 50); } ?></div>
            </div>
            <div class='fila'>
        ...
        <div class='fila'>
            <div class='col' style='width: 250px;text-align:center;font-size: 9px;text-align: justify;'><b>NOTA:</b>  No valido como comprobante de pago. Sirvase canjear por Boleta o Factura al momento de la emision de esta GUIA.<br>
            </div>
        </div>
        <div class='fila' style='height:16px;'>
            <div class='col' style='width: 250px;text-align:center;'><?php echo $pagina_web['value'];?></div>
