...
?>
        <div class='tabla'>
            ...
            <div class='fila' style='height: 16px;' >
                <div class='col' style='width: 160px;font-size: 15px;'>VENTA EXCESOS</div>
            </div>
            <div class='fila'>
            ...
            $total_exceso=0;
            $i=1;
            foreach ($ventas_excesos as $value) {
                $id=$value->id;
                $Total=$value->total;
                if ($value->canceled=='0') {
                    echo "<div class='fila'>";
                    ...
                    echo '</div>';
                    $total_exceso=$total_exceso+$Total;
                }else{
                    echo "<div class='fila'>";
                        echo "<div class='col' style='height: 11px;width: 20px;text-align: left;'>".$i.'</div>';
                        echo "<div class='col' style='height: 11px;width: 70px;text-align: left;'>".$value->serie.'-'.$value->number.'</div>';
            ...
            <div class='fila' style='height: 16px;' >
                <div class='col' style='width: 100px;font-size: 13px;'><b>TOTAL EXCES.</b></div>
                <div class='col' style='width: 60px;font-size: 13px;text-align: right;'><b><?php echo number_format($total_exceso,2); ?></b></div>
            </div>           
