...
?>
        ...
        <div class='tabla'>
            ...
            <div class='fila'>
                <div class='col' style='width: 250px;font-size: 13px;text-align:center;'>LIQUIDACION POR SALIDA </div>
            </div>
            <div class='fila'>
                <div class='col' style='width: 250px;font-size: 18px;text-align:center; font-weight: bold;'>BUS: <?=$placa;?></div>
            </div>
            
            <div class='fila' style='height:7px;'></div>
            <div class='fila'>
                <div class='col' style='width: 260px;font-size: 13px; font-weight: bold;'> RUTA: <?php echo $ruta; ?></div>
            </div>
            <div class='fila'>
                <div class='col' style='width: 260px;font-size: 13px;'> FECHA SALIDA: <b><?php echo $date; ?></b></div>
            </div>
            <div class='fila' style='height:10px;'>
                <div class='col' style='width: 260px;font-size: 13px;'> HORA SALIDA : <b><?php echo $hour; ?></b></div>             
            </div>
            <div class='fila' style='height:10px;'></div>
            ...
            foreach ($ventas_pasajes as $value) {
                ...
                if ($value->cancel_sale=='1') {
                    ...
                    $total_pasajes=$total_pasajes+$Total;
                }elseif ($value->type_payment==1) {                     //add yape
                    $total_pasajes=$total_pasajes+$Total;
                }elseif ($value->type_payment==3) {
                    $total_pasajes_yape=$total_pasajes_yape+$Total;     //end add yape
                }else{
                    $total_pasajes=$total_pasajes+$Total;
                }
            ...
            <div class='fila' style='height: 16px;' >
                <div class='col' style='width: 240px;font-size: 14px;text-align: center;font-weight: bold;'>VENTA DE PASAJES</div>
            </div><br>
            <div class='fila'>
                <div class="col" style="width: 140px; font-size: 12px; text-align:center;"><b>OFICINA</b></div>
                <div class="col" style="width: 40px; font-size: 12px; text-align:center;"><b>CANT.</b></div>
                <div class="col" style="width: 60px; font-size: 12px; text-align:center;"><b>MONTO</b></div>
            </div>
            <?php 
                $cantTotal = 0;
                $montoTotal= 0;
            ...
            <?php foreach ($fndProgOrigen as $value): ?>
                <div class='fila' style='height:7px;'>
                    <div class="col" style="width: 140px; font-size:14px; border:1px dotted;"><?=$value->abrev;?></div>
                    <div class="col" style="width: 40px; font-size:14px; text-align: center; border:1px dotted;"><b><?=$value->contar;?></b></div>
                    <div class="col" style="width: 60px; font-size:14px; text-align: right; border:1px dotted;"><b><?=$value->sumar;?></b></div>
                </div>
                <?php 
                    $cantTotal += $value->contar;
                    $montoTotal += $value->sumar;
                 ?>
            <?php endforeach ?>
            <div class='fila'>
                <div class="col" style="width: 140px; font-size: 15px; text-align:right; border:1px dotted;"><b>TOTAL</b> </div>
                <div class="col" style="width: 40px; font-size: 15px; text-align:center; border:1px dotted;"><b><?=$cantTotal;?></b></div>
                <div class="col" style="width: 60px; font-size: 15px; text-align:right; border:1px dotted;"><b><?= number_format($montoTotal,2);?></b></div>
            </div> 
            ...
            <div class='fila' style='height: 16px;' >
                ...
                <?php 
                $total=$total_pasajes_yape+$total_commends+$total_pasajes+$total_excesos-$total_gastos;
                ?>
                <div class='col' style='width: 60px;font-size: 15px;text-align: right;'><b><?php echo number_format($montoTotal,2); ?></b></div>
            </div>  
                    
        <div class='fila' style='height:5px;'></div>
        <div class='fila'>
            <div class='col' style='width: 250px;'>SON : <?php echo numtoletras($montoTotal);?></div>
        </div>
        <br><br>
        <!--detalle de ventas-->
        <!--<div class='fila'>
            <div class='col' style='width: 250px; text-align: center;'><b>* DETALLE DE VENTAS POR USUARIO *</b></div>
        </div>
        <div class='fila'>
            <div class='col' style='width: 60px;'><b>Fecha</b></div>
            <div class='col' style='width: 80px;'><b>Usuario</b></div>
            <div class='col' style='width: 60px;'><b>S/.</b></div>
            <div class='col' style='width: 50px;'><b>Cant. A</b></div>
        </div>-->
        ...
        <script>
            <?php if ($agenceIde!=59):?>    //59-> agencia de CUSCO
